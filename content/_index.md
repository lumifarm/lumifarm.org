...
<div style="text-align: center; max-width: 800px; margin: 0 auto 6rem auto; color: white;">
  ...
  <div style="display: flex; justify-content: center; gap: 1.5rem; align-items: center;">
    <a href="https://lumifarm.substack.com" target="_blank" style="color: white; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
    ...
    <a href="https://www.facebook.com/luminous.farmers.network" target="_blank" style="color: white; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
    ...
    <a href="https://www.instagram.com/luminous.farmers.network" target="_blank" style="color: white; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
    ...
    <a href="https://www.youtube.com/@luminous-farmers-network" target="_blank" style="color: white; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
